...
import { Award, FolderHeart, UserPlus } from 'lucide-react';
    ...
    <div className="flex flex-col md:flex-row justify-between gap-4 items-start md:items-center bg-white/95 p-5 sm:p-6 rounded-[28px] border border-purple-100/80 shadow-[0_8px_30px_rgba(124,58,237,0.05)]">
      ...
      <div className="flex flex-wrap items-center gap-2.5 w-full md:w-auto">
        {!isParent ? (
          ...
          <div className="flex items-center gap-2">
            <span className="px-3.5 py-2 rounded-2xl bg-purple-50 text-purple-700 text-xs font-bold border border-purple-200">
              👨‍👩‍👧 Bấm vào học sinh để xem sổ nề nếp
            </span>
          </div>
        )}
      </div>
